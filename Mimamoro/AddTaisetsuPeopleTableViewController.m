//
//  AddTaisetsuPeopleTableViewController.m
//  Mimamoro
//
...
@interface AddTaisetsuPeopleTableViewController ()<imageDelegate>
{
...
@implementation AddTaisetsuPeopleTableViewController
...
- (IBAction)savaAction:(id)sender {
    ...
    if (_editType == 0) {
        ...
        [[NSUserDefaults standardUserDefaults]setObject:groupArr forKey:@"group8"];
    }else if (_editType == 1){
...
- (IBAction)selectImageAction:(id)sender {
    [self performSegueWithIdentifier:@"gotoPersonImageTVCC" sender:self];
}

-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    TaisetsuPeopleImageCollectionViewController *perVC = segue.destinationViewController;
