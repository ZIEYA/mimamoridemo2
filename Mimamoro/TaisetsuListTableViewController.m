//
//  TaisetsuListTableViewController.m
//  Mimamoro
//
...
#import "TaisetsuListTableViewController.h"
#import "AddTaisetsuPeopleTableViewController.h"
@interface TaisetsuListTableViewController ()
{
...
@implementation TaisetsuListTableViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self performSegueWithIdentifier:@"gotoAddTaisetsuVCCC" sender:self];
}
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        [[NSUserDefaults standardUserDefaults]setObject:_groArray forKey:@"group8"];
        [self reloadGroups];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    AddTaisetsuPeopleTableViewController *editTVC = segue.destinationViewController;
